...
<h1 class="text-3xl font-bold tracking-tight text-gray-900">Crea Un Nuevo Producto</h1>
</div>
</header>
...
<br>
<p > llene todos los campos del nuevo producto a registrar</P>
<hr class="my-6">

<label class="uppercase text-sm font-bold opacity70">Nombre</label>
<br>
<input type="text" name="nombre" class="p-3 mt-2 mb-4 wfull bg-slate-200 rounded border-2 border-slate-200 focus:border-slate600 focus:outline-none">
<br>
<label class="uppercase text-sm font-bold opacity70">Precio</label>
<br>
<input type="text" name="precio" class="p-3 mt-2 mb-4 wfull bg-slate-200 rounded border-2 border-slate-200 focus:border-slate600 focus:outline-none">
<br>
<label class="uppercase text-sm font-bold opacity70">Descripcion</label>
<input type="text" name="descripcion" class="p-3 mt-2 mb4 w-full bg-slate-200 rounded">
<label class="uppercase text-sm font-bold opacity70">Categoria</label>
<input type="text" name="categoria" class="p-3 mt-2 mb-4
