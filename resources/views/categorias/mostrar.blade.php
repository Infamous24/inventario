...
<h3 class="text-base font-semibold leading-7 text-gray900">Este es el ID de categoria: {{ $categoria->id }}</h3>
...
<a href="{{ route('categoria.principal') }}"><button class="text-base rounded-r-none hover:scale-110 focus:outlinenone flex justify-center px-4 py-2 rounded font-bold cursor-pointer
hover:bg-gray-200
bg-gray-100
text-gray-700
...
<a href="{{ route('categorias.editar',$categoria) }}"><button class="text-base rounded-l-none hover:scale-110 focus:outlinenone flex justify-center px-4 py-2 rounded font-bold cursor-pointer
